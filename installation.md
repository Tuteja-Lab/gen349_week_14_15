...
After installing and initializing MFA:

* Login to the Nova cluster by repeating Step 2.
* Type the 6-digit code generated by the MFA app when prompted for "Verification Code" is prompted. **Note:** It will not show anything on the screen when you enter the code, but it's actually still recording what you type in. Click enter once you finish typing in the code.
